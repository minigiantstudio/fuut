...
```
Task(
  prompt="Read /Users/jaiversin/Development/fuut/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jaiversin/Development/fuut/.gemini/get-shit-done/templates/SECURITY.md`
