...
```bash
node "/Users/jaiversin/Development/fuut/.gemini/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/jaiversin/Development/fuut/.gemini/get-shit-done/templates/retrospective.md`.
