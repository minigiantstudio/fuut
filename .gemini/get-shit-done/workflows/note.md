...
- **Global scope**: `/Users/jaiversin/Development/fuut/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jaiversin/Development/fuut/.gemini/notes/`)
...
2. Glob `/Users/jaiversin/Development/fuut/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jaiversin/Development/fuut/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jaiversin/Development/fuut/.gemini/notes/` — works in any directory
