...
```bash
INIT=$(node "/Users/jaiversin/Development/fuut/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jaiversin/Development/fuut/.gemini/get-shit-done/templates/spec.md.
