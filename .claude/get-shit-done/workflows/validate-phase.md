...
```
Task(
  prompt="Read /Users/jaiversin/Development/fuut/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jaiversin/Development/fuut/.claude/get-shit-done/templates/VALIDATION.md`
