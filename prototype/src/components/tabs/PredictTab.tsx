...
const allMatches: Match[] = [
  // Matchday 1
  { id: 1, home: "Morocco", away: "Croatia", homeScore: "", awayScore: "", status: "open", stage: "Matchday 1", group: "Group A", date: "Jun 11, 2026" },
  { id: 2, home: "USA", away: "Mexico", homeScore: "", awayScore: "", status: "open", stage: "Matchday 1", group: "Group B", date: "Jun 11, 2026" },
  { id: 3, home: "France", away: "Australia", homeScore: "1", awayScore: "2", status: "saved", stage: "Matchday 1", group: "Group C", date: "Jun 12, 2026" },
  { id: 4, home: "Brazil", away: "Serbia", homeScore: "3", awayScore: "1", status: "locked", stage: "Matchday 1", group: "Group D", date: "Jun 12, 2026" },
  { id: 5, home: "Spain", away: "Japan", homeScore: "", awayScore: "", status: "needs_result", stage: "Matchday 1", group: "Group E", date: "Jun 12, 2026" },
  // Matchday 2
  { id: 6, home: "Croatia", away: "Canada", homeScore: "", awayScore: "", status: "open", stage: "Matchday 2", group: "Group A", date: "Jun 15, 2026" },
  { id: 7, home: "Mexico", away: "Poland", homeScore: "", awayScore: "", status: "open", stage: "Matchday 2", group: "Group B", date: "Jun 15, 2026" },
  { id: 8, home: "Argentina", away: "Saudi Arabia", homeScore: "", awayScore: "", status: "open", stage: "Matchday 2", group: "Group C", date: "Jun 16, 2026" },
  { id: 9, home: "Germany", away: "Japan", homeScore: "", awayScore: "", status: "open", stage: "Matchday 2", group: "Group D", date: "Jun 16, 2026" },
  // Matchday 3
  { id: 10, home: "Morocco", away: "Canada", homeScore: "", awayScore: "", status: "open", stage: "Matchday 3", group: "Group A", date: "Jun 19, 2026" },
  { id: 11, home: "USA", away: "Poland", homeScore: "", awayScore: "", status: "open", stage: "Matchday 3", group: "Group B", date: "Jun 19, 2026" },
  { id: 12, home: "France", away: "Argentina", homeScore: "", awayScore: "", status: "open", stage: "Matchday 3", group: "Group C", date: "Jun 20, 2026" },
  // Round of 16
  { id: 13, home: "TBD", away: "TBD", homeScore: "", awayScore: "", status: "open", stage: "Round of 16", date: "Jun 23, 2026" },
  { id: 14, home: "TBD", away: "TBD", homeScore: "", awayScore: "", status: "open", stage: "Round of 16", date: "Jun 23, 2026" },
  // Quarter-finals
  { id: 15, home: "TBD", away: "TBD", homeScore: "", awayScore: "", status: "open", stage: "Quarter-finals", date: "Jun 27, 2026" },
  // Semi-finals
  { id: 16, home: "TBD", away: "TBD", homeScore: "", awayScore: "", status: "open", stage: "Semi-finals", date: "Jun 30, 2026" },
  // Final
  { id: 17, home: "TBD", away: "TBD", homeScore: "", awayScore: "", status: "open", stage: "Final", date: "Jul 3, 2026" },
];
...
const PredictTab = ({ isAdmin = false }: PredictTabProps) => {
  ...
  const handleScoreChange = (id: number, field: "homeScore" | "awayScore", value: string) => {
    if (value !== "" && !/^\d{0,2}$/.test(value)) return;
    setMatches((prev) =>
      prev.map((m) => (m.id === id ? { ...m, [field]: value, status: m.status === "locked" ? "locked" : "open" } : m))
    );
  };
  ...
  const handleBlur = (id: number) => {
    ...
    blurTimeout.current = setTimeout(() => {
      setMatches((prev) =>
        prev.map((m) => {
          if (m.id !== id || m.status === "locked") return m;
          return m.homeScore !== "" && m.awayScore !== "" ? { ...m, status: "saved" } : m;
        })
      );
    }, 100);
  };
  ...
  const handleRowTap = (match: Match) => {
    if (match.status === "locked" || match.status === "needs_result") return;
  ...
  const handleResultConfirm = (homeScore: number, awayScore: number) => {
    ...
    setMatches((prev) =>
      prev.map((m) =>
        m.id === resultMatch.id
          ? { ...m, homeScore: String(homeScore), awayScore: String(awayScore), status: "locked" as MatchStatus }
          : m
      )
    );
  };
    ...
    setMatches((prev) =>
      prev.map((m) =>
        m.id === selectedMatch.id
          ? { ...m, homeScore: String(homeScore), awayScore: String(awayScore), status: "saved" }
          : m
      )
    );
  };
    ...
    <div className="py-5 space-y-4">
      ...
      <div className="space-y-3">
        ...
        {filteredMatches.map((match) => {
          ...
          const needsResult = match.status === "needs_result";
